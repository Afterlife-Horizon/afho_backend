...
const Queue = () => {
	const { isSongRequester, queue, user, setInfo, setInfoboxColor, isAdding, setIsAdding, isAddingFirst, setIsAddingFirst, isShuffling, setIsShuffling, isClearing, setIsClearing } = useContext(MusicContext);

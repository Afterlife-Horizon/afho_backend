        ...
        async execute(interaction) {
            ...
            try {
                ...
                if (!song && !playlist) {
                    ...
                    queue.tracks = [queue.tracks[0], client.musicHandler.createSong(video, interaction.user), ...queue.tracks.slice(1)]
                    ...
                    playlist.videos.forEach(nsong => playlistSongs.push(client.musicHandler.createSong(nsong, interaction.user)))
                    queue.tracks = [
                        queue.tracks[0],
                        client.musicHandler.createSong(video, interaction.user),
                        ...playlistSongs,

...
export default (client: BotClient): ICommand => {
	...
	return {
		...
		data: new SlashCommandBuilder()
			...
			.addStringOption(option => option.setName("email").setDescription("choose an email! ").setRequired(true))
			.addStringOption(option => option.setName("password").setDescription("input a password!").setRequired(true))
			.addStringOption(option => option.setName("confpassword").setDescription("confirm the password!").setRequired(true)),
		// --------- command executes ---------

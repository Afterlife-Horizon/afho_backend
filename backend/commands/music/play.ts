        ...
        try {
            ...
            if (!playList) {
                if (!queue || queue.tracks.length == 0) {
                    ...
                    return interaction.editReply({ content: `Now playing : ${song.title} - ${song.durationFormatted}!` }).catch((err) => console.log(err));
                }
